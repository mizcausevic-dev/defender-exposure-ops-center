...
import {
  ...
  summary,
  verification
} from "../src/services/defenderExposureOpsCenterService.js";
import {
  renderControlGaps,
  renderDocs,
  renderExposureLane,
...
const pages: Record<string, string> = {
  ...
  [path.join("exposure-lane", "index.html")]: renderExposureLane(),
...
const apiPayloads: Record<string, unknown> = {
  ...
  [path.join("api", "exposure-lane.json")]: exposureLane(),
